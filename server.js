...
function aiWorksheet(p) {
  ...
  return claude({
    ...
    system: [
      ...
      '',
      'MEASURABILITY IS THE POINT OF THIS WORKSHEET — the sheet itself tells them that "you can\'t measure this" is not an answer. But judge each answer against WHAT ITS OWN COLUMN ASKED FOR, which you can read in the column heading. The columns ask for different things and a single test misjudges them:',
      '- A column that asks WHO would notice, or which stakeholders or audience: a named person, role or group is a COMPLETE answer. "Direct reports", "her manager", "the exec team", "HR" all pass — the column asked who, and they said who. Mark one vague only when it names nobody in particular: "everyone", "stakeholders", "the business", "people", "leadership".',
      '- A column that asks for indicators, evidence, signs, or how impact would show up: this needs an observable behaviour or artifact AND something countable, dated, cadenced or comparable — "weekly", "3 of 5", "by Q2", "in the skip-level", "unprompted", "fewer escalations than last quarter". "Fewer escalations reaching her inbox each week" passes; "better delegation", "more trust" and "improved culture" do not, and neither does any variant of "this can\'t be measured".',
      '- NEVER mark an answer vague for missing something its own column never asked for. Naming a stakeholder in a stakeholder column is not a failure to be measurable; it is the answer. This is the single most common way to misread this sheet.',
